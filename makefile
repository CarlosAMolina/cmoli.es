...
HTML_BLOG_LOCAL_PATHNAME:=src/blog
...
HTML_WIKI_LOCAL_PATHNAME:=src/wiki
...
create-web:
	...
	./convert-md-to-html $(HTML_BLOG_LOCAL_PATHNAME)/2021-05-15-leer-periodicos-online-sin-iniciar-sesion.md $(HTML_BLOG_DESTINATION_PATHNAME)/2021-05-15-leer-periodicos-online-sin-iniciar-sesion.html $(HTML_BLOG_CSS_DESTINATION_PATHNAME) $(PANDOC_TEMPLATE_DESTINATION_PATHNAME) $(PANDOC_METADATA_DESTINATION_PATHNAME)
