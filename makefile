...
create-web:
	...
	cp index.html $(HTML_DESTINATION_PATHNAME)
	cp index.css $(HTML_DESTINATION_PATHNAME)
	cp avatar.png $(HTML_DESTINATION_PATHNAME)
	cp blog/blog.css $(HTML_BLOG_CSS_DESTINATION_PATHNAME)
	cp -r felices-fiestas $(HTML_DESTINATION_PATHNAME)
	cp pandoc-config/* $(PANDOC_CONFIG_DESTINATION_PATHNAME)/
	./convert-md-to-html blog/2021-05-15-leer-periodicos-online-sin-iniciar-sesion.md $(HTML_BLOG_DESTINATION_PATHNAME)/2021-05-15-leer-periodicos-online-sin-iniciar-sesion.html $(HTML_BLOG_CSS_DESTINATION_PATHNAME) $(PANDOC_TEMPLATE_DESTINATION_PATHNAME) $(PANDOC_METADATA_DESTINATION_PATHNAME)
	./convert-md-to-html blog/2021-09-12-utilizar-protonmail-con-tor-y-no-con-protonvpn.md $(HTML_BLOG_DESTINATION_PATHNAME)/2021-09-12-utilizar-protonmail-con-tor-y-no-con-protonvpn.html $(HTML_BLOG_CSS_DESTINATION_PATHNAME) $(PANDOC_TEMPLATE_DESTINATION_PATHNAME) $(PANDOC_METADATA_DESTINATION_PATHNAME)
