...
create-web:
	...
	cp favicon.ico $(OUTPUT_LOCAL_PATHNAME)
	cp robots.txt $(OUTPUT_LOCAL_PATHNAME)
...
send-files:
	scp -P $(VPS_DEV_PORT) -r $(OUTPUT_LOCAL_PATHNAME)/ $(VPS_DEV_USER)@$(VPS_DEV_IP):$(SRC_OUTPUT_VPS_PATHNAME)/
