...
PROJECTS_SRC_OUTPUT_LOCAL_PATHNAME:=$(SRC_OUTPUT_LOCAL_PATHNAME)/projects
...
create-web:
	...
	./convert-md-to-html $(PROJECTS_SRC_OUTPUT_LOCAL_PATHNAME)/requests-custom/introduction.md $(PROJECTS_SRC_OUTPUT_LOCAL_PATHNAME)/requests-custom/introduction.html ../$(CSS_BLOG_SRC_OUTPUT_LOCAL_PATHNAME) $(PANDOC_TEMPLATE_INPUT_LOCAL_PATHNAME) $(PANDOC_METADATA_INPUT_LOCAL_PATHNAME)
